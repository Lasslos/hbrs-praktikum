...
class USBdeviceDescriptor_0 : public USBdeviceDescriptor
{
  ...
  public:
                                       ...
                                       BYTE ID )
    {
      switch( getId( typeID, confID, interfID, ID ) )
      {
        ...
        case 0x6002: return( DataPointer( ( BYTE* )&descriptor[ 66],  8 ) ); // String
        case 0x6003: return( DataPointer( ( BYTE* )&descriptor[ 74], 14 ) ); // String
        case 0x6004: return( DataPointer( ( BYTE* )&descriptor[ 88], 10 ) ); // String
        case 0x6005: return( DataPointer( ( BYTE* )&descriptor[ 98], 18 ) ); // String
        case 0x60EE: return( DataPointer( ( BYTE* )&descriptor[116], 18 ) ); // String
        case 0x7000: return( DataPointer( ( BYTE* )&descriptor[134], 40 ) ); // Compat
      }
      return( DataPointer(  ) );
    }
  ...
  private:
    //---------------------------------------------------------------
    static const BYTE          descriptor[175];
...
//
//-------------------------------------------------------------------
const BYTE USBdeviceDescriptor_0::descriptor[175] =
{
