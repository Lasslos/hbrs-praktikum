 ...
 void SensorAnalog::setPinMode( Port::Pin &pin, BYTE mode )
{
  switch( mode & 0x07 )
  {
    case 0:  pin.setMode( Port::In   ); break;
    case 1:  pin.setMode( Port::InPU ); break;
    case 2:  pin.setMode( Port::InPD ); break;
    case 3:  /*analog ? */                 break;
    case 4:  pin.setMode( Port::OutOD); break;
    case 5:  pin.setMode( Port::OutPU); break;
    case 6:  pin.setMode( Port::OutPP); break;
    case 7:  /* ? */                       break;
    default:                               break;
  }
